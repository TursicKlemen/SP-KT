...
document.getElementById("cameraShow").addEventListener("click", function(event){
    ...
    document.getElementById("zajemiPix").addEventListener("click", function(event){
        ...
        if(!createdCanvas){
            ...
            document.getElementById("slika").offsetWidth = document.getElementById("video").offsetWidth;
            document.getElementById("slika").offsetHeight = document.getElementById("video").offsetHeight;
